...
[ASCII box-drawing tree of top-level directories with purpose - use special characters for tree structure only]
...
**New Slash Command:**
- Primary code: `commands/tsx/{command-name}.md`
- Tests: `tests/commands/{command-name}.test.js` (if testing implemented)
- Documentation: Update `README.md` with new command

**New Template:**
- Implementation: `topstepx/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `topstepx/workflows/{name}.md`
- Usage: Reference from command with `@$HOME/.claude/topstepx/workflows/{name}.md`

**New Reference Document:**
- Implementation: `topstepx/references/{name}.md`
