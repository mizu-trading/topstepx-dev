...
**Orchestrator role:** Gather symptoms, spawn tsx-debugger agent, handle checkpoints, spawn continuations.
...
- Offer options:
  ...
  - "Plan fix" - suggest /tsx:plan-phase --gaps
  - "Manual fix" - done
...
- [ ] tsx-debugger spawned with context
